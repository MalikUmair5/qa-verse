      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-2">
            <button 
              onClick={onReportBug}
              className="flex-1 px-3 py-2 bg-orange-600 hover:bg-orange-700 text-white text-xs font-medium rounded-md transition-colors duration-200 whitespace-nowrap"
            >
              Report Bug
            </button>
            <button 
